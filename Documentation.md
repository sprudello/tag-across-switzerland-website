...
| 4.2  | User logged in                                           | User completes the challenge successfully                                                        | User earns currency as a reward                                                                                |
| 4.3  | User logged in                                           | User fails to complete the challenge                                                             | User does not earn currency.                                                                                   |
| 4.4  | User logged in                                           | User pulls multiple challenges consecutively                                                     | Each challenge pulled is unique and random                                                                     |
| 4.1  | 4                                                        | User logged in                                                                                   | User selects "Pull Challenge" option                                                                           |
| 4.2  | 4, 5                                                     | User presented with a challenge                                                                  | User completes the challenge successfully                                                                      |
| 4.3  | 4                                                        | User presented with a challenge                                                                  | User fails to complete the challenge                                                                           |
| 6.1  | 6                                                        | User presented with a challenge                                                                  | User chooses to fail or veto the challenge                                                                     |
| 7.1  | 7                                                        | User has already pulled a challenge                                                              | User attempts to pull another challenge                                                                        |
